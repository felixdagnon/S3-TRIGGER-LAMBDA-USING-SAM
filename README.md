...
We use this link to add additional resources from event souce types; https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/sam-property-function-eventsource.html
